...
//  2020-02-20: Inputs: Fixed mapping for ImGuiKey_KeyPadEnter (using SDL_SCANCODE_KP_ENTER instead
//  of SDL_SCANCODE_RETURN2). 2019-12-17: Inputs: On Wayland, use SDL_GetMouseState (because there
//  is no global mouse state). 2019-12-05: Inputs: Added support for ImGuiMouseCursor_NotAllowed
//  mouse cursor. 2019-07-21: Inputs: Added mapping for ImGuiKey_KeyPadEnter. 2019-04-23: Inputs:
//  Added support for SDL_GameController (if ImGuiConfigFlags_NavEnableGamepad is set by user
...
//  2018-06-08: Misc: Extracted imgui_impl_sdl.cpp/.h away from the old combined SDL2+OpenGL/Vulkan
//  examples. 2018-06-08: Misc: ImGui_ImplSDL2_InitForOpenGL() now takes a SDL_GLContext parameter.
//  2018-05-09: Misc: Fixed clipboard paste memory leak (we didn't call SDL_FreeMemory on the data
//  returned by SDL_GetClipboardText). 2018-03-20: Misc: Setup io.BackendFlags
...
//  ImGuiKey_Space. 2018-02-05: Misc: Using SDL_GetPerformanceCounter() instead of SDL_GetTicks() to
//  be able to handle very high framerate (1000+ FPS). 2018-02-05: Inputs: Keyboard mapping is using
//  scancodes everywhere instead of a confusing mixture of keycodes and scancodes. 2018-01-20:
//  Inputs: Added Horizontal Mouse Wheel support. 2018-01-19: Inputs: When available (SDL 2.0.4+)
//  using SDL_CaptureMouse() to retrieve coordinates outside of client area when dragging. Otherwise
